...
#if 0
PNAME(vpll_p)		= { "mout_vpllsrc", "fout_vpll", };
#else
PNAME(vpll_p)		= { "fout_vpll", "mout_vpllsrc",  };
#endif
...
PNAME(mpll_bpll_user_p)	= { "sclk_mpll_muxed", "sclk_bpll_muxed", };
...
PNAME(group6_p)		= { "fin_pll", "sclk_mpll_bpll",};
PNAME(aclk200_disp1_p)	= { "fin_pll", "mout_aclk200",};
...
static struct samsung_mux_clock exynos5410_pll_mux_clks[] __initdata = {
	MUX(0, "mout_vpllsrc", vpllsrc_p, SRC_TOP2, 0, 1),
};
...
static struct samsung_mux_clock exynos5410_mux_clks[] __initdata = {
	...
	MUX_F(CLK_SCLK_VPLL, "sclk_vpll", vpll_p, SRC_TOP2, 16, 1,
	...
	MUX(0, "sclk_mpll_bpll", mpll_bpll_user_p, SRC_TOP1, 20, 1),
	MUX(CLK_MOUT_HDMI, "mout_hdmi", mout_hdmi_p, SRC_DISP10, 20, 1),
	...
	MUX(0, "mout_usbd300", group6_p, SRC_FSYS, 28, 1),
	MUX(0, "mout_usbd301", group6_p, SRC_FSYS, 29, 1),
	...
	MUX(0, "mout_aclk200", mpll_bpll_user_p, SRC_TOP0, 12, 1),
	MUX(0, "mout_aclk400", mpll_bpll_user_p, SRC_TOP0, 20, 1),
};
...
static struct samsung_div_clock exynos5410_div_clks[] __initdata = {
	...
	/* USB 3.0 */
	DIV(0, "div_usbphy300", "mout_usbd300", DIV_FSYS1, 16, 4),
	DIV(0, "div_usbphy301", "mout_usbd301", DIV_FSYS1, 20, 4),
	DIV(0, "div_usbd300", "mout_usbd300", DIV_FSYS1, 24, 4),
	DIV(0, "div_usbd301", "mout_usbd301", DIV_FSYS1, 28, 4),

	DIV(0, "div_mmc0", "mout_mmc0", DIV_FSYS1, 0, 4),
	DIV(0, "div_mmc1", "mout_mmc1", DIV_FSYS1, 16, 4),
	DIV(0, "div_mmc2", "mout_mmc2", DIV_FSYS2, 0, 4),
	
	DIV(CLK_SCLK_PIXEL, "div_hdmi_pixel", "sclk_vpll", DIV_DISP10, 28, 4),
...
static struct samsung_gate_clock exynos5410_gate_clks[] __initdata = {
	...
	GATE(CLK_SCLK_USBD300, "sclk_usbd300", "div_usbphy300",
	...
	GATE(CLK_DP1, "dp1", "mout_aclk200_disp1", GATE_IP_DISP1, 4, 0, 0),
	GATE(CLK_MIXER, "mixer", "mout_aclk200_disp1", GATE_IP_DISP1, 5, 0, 0),
	GATE(CLK_HDMI, "hdmi", "mout_aclk200_disp1", GATE_IP_DISP1, 6, 0, 0),
	GATE(CLK_SMMU_FIMD1, "smmu_fimd1", "aclk300_disp1", GATE_IP_DISP1, 8, 0, 0),

	GATE(CLK_USBH20, "usbh20", "aclk200", GATE_BUS_FSYS0, 20, 0, 0),
	GATE(CLK_USBD300, "usbd300", "aclk200", GATE_BUS_FSYS0, 21, 0, 0),
	GATE(CLK_USBD301, "usbd301", "aclk200", GATE_BUS_FSYS0, 28, 0, 0),
};
...
static struct samsung_pll_clock exynos5410_plls[nr_plls] __initdata = {
	...
	[ipll] = PLL(pll_35xx, CLK_FOUT_IPLL, "fout_ipll", "fin_pll", IPLL_LOCK,
		IPLL_CON0, NULL),
	[vpll] = PLL(pll_36xx, CLK_FOUT_VPLL, "fout_vpll", "mout_vpllsrc", VPLL_LOCK,
		VPLL_CON0, NULL),
};
...
static struct samsung_pll_rate_table vpll_24mhz_tbl[] = {
	...
	PLL_36XX_RATE(350000000, 220, 3, 2, 0),
	PLL_36XX_RATE(330000000, 111, 2, 2, 0),
